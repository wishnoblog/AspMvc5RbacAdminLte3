namespace Application.Migrations
{
    ...
    public partial class rename_user_table : DbMigration
    {
        public override void Up()
        {
            RenameTable(name: "dbo.ApplicationGroupRoles", newName: "GroupRoles");
        ...
        public override void Down()
        {
            ...
            RenameTable(name: "dbo.GroupRoles", newName: "ApplicationGroupRoles");
        }
    }
}
